				...
				<section className="script-description">
						...
						{tags?.nodes?.length ? (
                            ...
                            <aside className="script-similar-scripts lg:col-span-1">
                                <div className="rounded-lg border text-card-foreground shadow-sm sticky top-20 bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 lg:w-[400px] h-[auto] pb-[20px]">
